  ...
  <body>
    ...
    <div class="sidebar">
        ...
        <div class="box-1 text-center">
            <h2 style="font-size: 30px; color: #262626;">Edit Data Berita</h2>
            <div class="card">
            <div class="card-body">
            <form action="" method="post" class="mt-3" enctype="multipart/form-data">
                
                <input type="text" name="judul" id="judul"
                required="required" autofocus placeholder="Judul Berita" autocomplete="off" class="form-order" value="<?php echo $berita["judul"]; ?>"><br>
                
                <input type="textarea" name="isi" id="isi" autofocus placeholder="Isi Berita" class="form-order, ket" value="<?php echo $berita["isi"]; ?>"><br>
        
                <label for="foto">Gambar :</label>
                <input type="file" name="foto" id="foto" class="form-order" value="img/berita/<?php echo $berita["gambar"]; ?>"><br>

                <input type="text" name="sumber" id="sumber"
                required="required" autofocus placeholder="Sumber Berita" autocomplete="off" class="form-order" value="<?php echo $berita["sumber"]; ?>"><br>
