...
<html lang="en">
  ...
  <body>
    ...
    <div class="wrapper">
        ...
        <div class="box-1">
            <h2 style="font-size: 30px; color: #262626;" class="text-center">Edit Data Penarikan</h2>
            <div class="card">
            <div class="card-body">
            ...
            <div class="form-group mt-2">
                ...
                <input type="date" name="tanggal" id="tanggal" required="required" class="input-group date" value="<?php echo $penarikan["tglTarik"]; ?>">
            </div>
            <div class="form-group mt-2">
                <label for="jmlPenarikan">Jumlah Saldo yang Ditarik :</label>
                <input type="number" name="jmlPenarikan" id="jmlPenarikan" required="required" class="form-order" value="<?php echo $penarikan["jmlPenarikan"]; ?>" style="width: 100%;">
            </div>
