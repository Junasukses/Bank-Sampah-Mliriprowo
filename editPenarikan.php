    ...
    <div class="sidebar">
        ...
        <div class="box-1 text-center">
            ...
            <form action="" method="post" class="mt-3" enctype="multipart/form-data">
                ...
                <input type="date" name="tanggal" id="tanggal" required="required" class="form-order" value="<?php echo $penarikan["tglTarik"]; ?>"><br>

                <label for="jmlPenarikan">Jumlah Saldo yang Ditarik :</label>
                <input type="text" name="jmlPenarikan" id="jmlPenarikan" required="required" class="form-order" value="<?php echo $penarikan["jmlPenarikan"]; ?>"><br>
