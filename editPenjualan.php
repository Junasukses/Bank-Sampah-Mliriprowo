  ...
  <body>
    ...
    <div class="sidebar">
        ...
        <div class="box-1 text-center">
            <h2 style="font-size: 30px; color: #262626;">Edit Data Penjualan</h2>
            <div class="card">
            <div class="card-body">
            <form action="" method="post" class="mt-3" enctype="multipart/form-data">
                ...
                <input type="text" name="berat" id="berat" required="required" class="form-order" value="<?php echo $penjualan["berat"]; ?>"><br>

                <label for="tanggal">Tanggal Penarikan :</label>
                <input type="date" name="tanggal" id="tanggal" required="required" class="form-order" value="<?php echo $penjualan["tglPenjualan"]; ?>"><br>

                <label for="nama">Nama Pembeli :</label>
                <input type="text" name="nama" id="nama" required="required" class="form-order" value="<?php echo $penjualan["namaPembeli"]; ?>"><br>

                <label for="nomor">Nomor Pembeli :</label>
                <input type="text" name="nomor" id="nomor" required="required" class="form-order" value="<?php echo $penjualan["nomorPembeli"]; ?>"><br>

                <label for="harga">Harga Penjualan/Kg :</label>
                <input type="text" name="harga" id="harga" required="required" class="form-order" value="<?php echo $penjualan["harga"]; ?>"><br>
