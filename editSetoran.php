...
<html lang="en">
  ...
  <body>
    ...
    <div class="wrapper">
        ...
        <div class="box-1">
            <h2 class=" text-center" style="font-size: 30px; color: #262626;">Edit Setoran</h2>
            <div class="card">
            <div class="card-body">
            <form action="" method="post" class="mt-3" enctype="multipart/form-data">
            <div class="form-group mt-2">    
                <label for="penyetor">Nama Penyetor :</label>
                    <select name="penyetor" id="penyetor" required="required" class="btn btn-info dropdown-toggle" style="width: 100%;">
            ...
            <div class="form-group mt-2">
                ...
                <input type="date" name="tanggal" id="tanggal" required="required" class='input-group date' value="<?php echo $setor["tglSetor"]; ?>">
            </div>
            <div class="form-group mt-2">
                <label for="berat">Berat :</label>
                <input type="number" name="berat" id="berat" required="required" class="form-order" style="width: 92%;"value="<?php echo $setor["berat"]; ?>">
