...
$stock = query("SELECT * FROM stock_sampah ORDER BY idStock ASC");
...
<html lang="en">
  <head>
    <title>Stock Sampah Admin</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
  ...
  <body>
    ...
    <div class="box-1 text-center">
        <h2 style="font-size: 30px; color: #262626;">Daftar Stock Sampah</h2>
        <div class="card">
          <div class="card-body">
          ...
          <table id="example" class="display" cellspacing="0" width="100%" border="0" >
            ...
            <tr align="center">
                ...
                <td>
                    <a onclick="return confirm('Anda yakin ingin menghapus data ini?')" href="hapus.php?action=delete&id=<?php echo $row["idStock"]; ?>">
