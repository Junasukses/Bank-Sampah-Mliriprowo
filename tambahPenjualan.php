...
<html lang="en">
  ...
  <body>
    ...
    <div class="wrapper">
        ...
        <div class="box-1">
            <h2 style="font-size: 30px; color: #262626;" class="text-center">Tambah Data Penjualan</h2>
            <div class="card">
            <div class="card-body">
            ...
            <div class="form-group mt-2">
                ...
                <input type="text" name="nama" id="nama" required="required" class="form-order" style="width: 100%;">
            </div>
            <div class="form-group mt-2">
