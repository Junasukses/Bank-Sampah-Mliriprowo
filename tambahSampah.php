  ...
  <body>
    ...
    <div class="sidebar">
        ...
        <div class="box-1 text-center">
            <h2 style="font-size: 30px; color: #262626;">Jenis Sampah</h2>
            <div class="card">
            <div class="card-body">
            <form action="" method="post" class="mt-3" enctype="multipart/form-data">
                <label for="jenisSampah">Jenis Sampah :</label><br>
                <select name="jenisSampah" id="jenisSampah" required="required" class="form-order">
                    <option>Organik</option>
                    <option>Anorganik</option>
                </select><br>

                <input type="text" name="namaSampah" id="namaSampah"
                required="required" autofocus placeholder="Nama Sampah" autocomplete="off" class="form-order"><br>

                <label for="satuan">Satuan :</label><br>
                <select name="satuan" id="satuan" required="required" class="form-order">
                    <option>KG</option>
                    <option>PC</option>
                    <option>LT</option>								
                </select><br>
                ...
                required="required" autofocus placeholder="Rp. " class="form-order"><br>
        
                <label for="foto">Gambar :</label>
                <input type="file" name="foto" id="foto" class="form-order"><br>
            
                <input type="textarea" name="keterangan" id="keterangan" autofocus placeholder="keterangan" class="form-order, ket"><br>
